...
static void *paradise_pvga1a_pc2086_init(const device_t *info)
{
        ...
        if (paradise)
                rom_init(&paradise->bios_rom, _S("roms/machines/pc2086/40186.ic171"), 0xc0000, 0x8000, 0x7fff, 0, MEM_MAPPING_EXTERNAL);
...
static void *paradise_pvga1a_pc3086_init(const device_t *info)
{
        ...
        if (paradise)
                rom_init(&paradise->bios_rom, _S("roms/machines/pc3086/c000.bin"), 0xc0000, 0x8000, 0x7fff, 0, MEM_MAPPING_EXTERNAL);
...
static void *paradise_pvga1a_standalone_init(const device_t *info)
{
	...
	memory <<= 10;
        ...
        if (paradise)
                rom_init(&paradise->bios_rom, _S("roms/video/pvga1a/BIOS.BIN"), 0xc0000, 0x8000, 0x7fff, 0, MEM_MAPPING_EXTERNAL);
...
{
        return rom_present(_S("roms/video/pvga1a/BIOS.BIN"));
}
...
static void *paradise_wd90c11_megapc_init(const device_t *info)
{
        ...
        if (paradise)
                rom_init_interleaved(&paradise->bios_rom,
                                     _S("roms/machines/megapc/41651-bios lo.u18"),
...
static void *paradise_wd90c11_standalone_init(const device_t *info)
{
        ...
        if (paradise)
                rom_init(&paradise->bios_rom, _S("roms/video/wd90c11/WD90C11.VBI"), 0xc0000, 0x8000, 0x7fff, 0, MEM_MAPPING_EXTERNAL);
...
{
        return rom_present(_S("roms/video/wd90c11/WD90C11.VBI"));
}
...
static void *paradise_wd90c30_standalone_init(const device_t *info)
{
	...
	memory <<= 10;
        ...
        if (paradise)
                rom_init(&paradise->bios_rom, _S("roms/video/wd90c30/90C30-LR.VBI"), 0xc0000, 0x8000, 0x7fff, 0, MEM_MAPPING_EXTERNAL);
...
{
        return rom_present(_S("roms/video/wd90c30/90C30-LR.VBI"));
}
